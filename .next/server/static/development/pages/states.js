...
const StatBlock = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.div`
  ...
  text-align: center;
`;
const ButtonStyle = styled_components__WEBPACK_IMPORTED_MODULE_2___default.a.button`
  display: flex;
  flex-direction: row;
...
const StateStats = ({
  ...
  return __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, __jsx(ButtonStyle, {
    __source: {
      fileName: _jsxFileName,
      lineNumber: 47
    },
